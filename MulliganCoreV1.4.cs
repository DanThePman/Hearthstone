...
namespace SmartBotUI.Mulligan
{
    ...
    public class bMulliganProfile : MulliganProfile
    {
        ...
        public class BoardCard
        {
            ...
            public bool HadBadEffect { get; private set; }
            ...
            public BoardCard(Card MulliganCard)
            {
                ...
                HadBadEffect = CardProperties.HasBadEffect(MulliganCard);
                EffectCount = CardProperties.EffectCount(MulliganCard);
        ...
        public class CardProperties
        {
            ...
            public static int EffectCount(Card MulliganCard)
            {
                return new BoardCard(MulliganCard).ResultingBoardCard.Mechanics.Count;
            }
            ...
            { //card quality not hight enough and mana to high too
                ...
                else if (boardCard.ResultingBoardCard.Cost >= ValueReader.MinManaCostToAttendValue)
                {
                        ...
                        !ValueReader.OnlyAddMinionIfHasEffect)
                    {
                        ...
                        if (minionCard.CardValue >= ValueReader.MinNeutralMinionValue)//resultingMinNeutralMinionValue)
                            chosenCards.Add(card);
                            ...
                            ValueReader.ValueIgnorer.IgnoreValueIfCardIsX_DropEtc)
                        {
                            ...
                            if (
                                ...
                                ||
                                (ValueReader.ValueIgnorer.MakeIgnoringOnlyIfNotBadEffect &&
                                !minionCard.BoardCard.HadBadEffect)
                                )
                                chosenCards.Add(card);
                        }
                    }
